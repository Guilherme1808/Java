...
public class LeituraDadosTeclado {
    ...
    public static void main(String[] args) {
         ...
         * scan.nextLine(); System.out.println("Seu nome completo é: " + nomeCompleto);
         * 
         ...
         * 
         * 
         * System.out.println("Digite a sua idade:"); int idade = scan.nextInt();
         * System.out.println("Sua idade é: " + idade);
         * 
         * System.out.println("Digite a sua altura:"); double altura =
         * scan.nextDouble(); System.out.println("A sua altura é: " + altura);
         */
